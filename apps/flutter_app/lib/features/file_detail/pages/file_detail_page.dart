          ...
          PopupMenuButton<String>(
            ...
            itemBuilder: (_) => [
              const PopupMenuItem(
                  ...
                  child: ListTile(
                      dense: true,
                      leading: Icon(Icons.image_search_rounded, size: 16),
                      title: Text('Explain Screenshot'))),
              const PopupMenuItem(
                  value: 'flashcards',
                  child: ListTile(
                      dense: true,
                      leading: Icon(Icons.style_rounded, size: 16),
                      title: Text('Generate Flashcards'))),
              const PopupMenuItem(
                  value: 'tag',
                  child: ListTile(
                      dense: true,
                      leading: Icon(Icons.label_rounded, size: 16),
                      title: Text('Auto-tag'))),
              ...
              const PopupMenuItem(
                  ...
                  child: ListTile(
                      dense: true,
                      leading: Icon(Icons.lock_rounded, size: 16),
  ...
  void _handleAction(BuildContext context, String action) {
    switch (action) {
      case 'explain':
        context
            .read<AiBloc>()
            .add(AiExplainFile(widget.fileId, AiExplainMode.screenshot));
        _tabs.animateTo(1);
      case 'flashcards':
  ...
  void _confirmDelete(BuildContext context) {
    showDialog(
      ...
      builder: (ctx) => AlertDialog(
        ...
        content: const Text(
            'This removes the file from your index. The original file will NOT be deleted.'),
        actions: [
          TextButton(
              ...
              child: Column(
                ...
                children: [
                  ...
                  if (state.status == AiStatus.thinking)
                    ...
                    Text(
                        'Tap "Summarize" to generate an AI summary of this file.',
              ...
              children: [
                Expanded(
                  child: _ExplainButton(
                    ...
                    onTap: () => context
                        .read<AiBloc>()
                        .add(AiExplainFile(fileId, AiExplainMode.screenshot)),
                  ),
                ),
                const SizedBox(width: 8),
                Expanded(
                  child: _ExplainButton(
                    ...
                    onTap: () => context
                        .read<AiBloc>()
                        .add(AiExplainFile(fileId, AiExplainMode.code)),
                  ),
                ),
                const SizedBox(width: 8),
                Expanded(
                  child: _ExplainButton(
                    ...
                    onTap: () => context
                        .read<AiBloc>()
                        .add(AiExplainFile(fileId, AiExplainMode.diagram)),
                  ),
                ),
              ],
            ),
